...
######## TetraMethyl   
    ...
    rm(list = ls()[!ls() %in% c("gene_destination_folder","input_folder","destination_folder","maxCG_pos","Stat","Selection","pvalue","CG_pos","Expected_Freq","percentile","nProcessor","combs_summary1","combs_summ_clust1","genes", "maps","summ_stat","unregister","combinations",
  ...
  #Erase everything except
  rm(list = ls()[!ls() %in% c("gene_destination_folder","input_folder","destination_folder","maxCG_pos","Selection","pvalue","percentile","nProcessor","combs_summary1","combs_summ_clust1","genes", "maps","summ_stat","unregister","combinations",
