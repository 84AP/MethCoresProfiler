  ...
  
{
  ...
  if (saveAs=="pdf") {
    pdf(paste("./",destination_folder,"/",sam,"_",ratio,"_co_Occurence_", gene,".pdf", sep=""),paper = "a4")
  } else {
  png(paste("./",destination_folder,"/",sam,"_",ratio,"_co_Occurence_", gene,".png", sep=""), width=5*300,height=5*300, res = 300,pointsize=8)
  }
  ...
  write.table(x = tab_list1, file = paste("./",destination_folder,"/",sam,"_",ratio,"_co_Occurence_Histogram_", gene,".txt",sep=""), quote=F,sep="\t",row.names=F)
  
  if (saveAs=="pdf") {
    pdf(paste("./",destination_folder,"/",sam,"_",ratio,"_co_Occurence_Histogram_", gene,".pdf", sep=""),paper = "a4")
  } else {
  png(paste("./",destination_folder,"/",sam,"_",ratio,"_co_Occurence_Histogram_", gene,".png",sep=""), width = 5*300,height = 5*300,res = 300,pointsize = 8) 
  }
