...
combinations<- function(cl,tab_Stat,gene_destination_folder) {
 ...
 #Assign Selection Type Respect to Exp_pvalue
  ...
  #test2[complete.cases(test2), ]
    ...
    #summary$samples=sam
    #summary$core=core
    summary1[nrow(summary1) + 1,] =NA
    summary1$shannon_entropy=NA
    summary1$RenyiEntropy=NA
    summary1$expected_Freq=NA
    summary1$observed_Freq=NA
    summary1$Exp_xSquared=NA
    summary1$Exp_pvalue=NA
    summary1$n=NA
    summary1$Random_Freq=NA
    summary1$Random_xSquared=NA
    summary1$Random_pvalue=NA
    summary1$Selection =NA
    summ_clust1[nrow(summ_clust1) + 1,] =NA
    test2=as.data.frame((summary1$core))
    colnames(test2)="core"
  }
